	...
	<form id="user_form" action="" method="post">
		...
		<table cellspacing="0" cellpadding="0">
			<tr class="thclass" style="height: 40px">
					...
					<td><input type="text" name="realname" class="easyui-validatebox"
			...
			<tr class="thclass" style="height: 40px">
				...
				<td>
					<input type="text" id="edit_areaid" name="areaid" required="true" missingMessage="所在地域不能为空" value="${userInfo.areaid }">		
				</td>
			</tr>
