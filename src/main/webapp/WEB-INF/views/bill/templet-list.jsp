	...
	<div class="easyui-layout" fit="true" border="false">
            ...
            <div id="toobar" style="padding:5px;height:auto">
				<div style="margin-bottom:5px">
					...
					<a href="#" class="easyui-linkbutton" iconCls="icon-add" plain="true" onClick="addWayFun()">新增科目</a>
					<a href="#" class="easyui-linkbutton" iconCls="icon-edit" plain="true" onClick="editWayFun()">编辑科目</a>
					<a href="#" class="easyui-linkbutton" iconCls="icon-remove" plain="true" onClick="delWayFun()">删除科目</a>
				</div>
    		</div>
	</div>
	...
	<script type="text/javascript">
		...
		function addFun() {
	    	var window_dialog = $('#form_window').dialog({
    			...
    			closed : false,
    			cache : false,
    			href : basepath+'/billtpl/dataform',
    			modal : true,
    			buttons : [ {
    				text : '保   存',
    				handler : function() {
    					var valid = $("#tpl_form").form('validate');
    					if(!valid){
    						return;
    					}
    					$('#tpl_form').form('submit',{
    						url : basepath+'/billtpl/save',
	    ...
	    function editFun() {
	    	...
	    	if (checkedRows.length == 1) {
	    		var window_dialog = $('#form_window').dialog({
	    			...
	    			closed : false,
	    			cache : false,
	    			href : basepath+'/billtpl/dataform?id='+checkedRows[0].id,
	    			modal : true,
	    			buttons : [ {
	    				text : '保   存',
	    				handler : function() {
