	...
	<table cellspacing="0" cellpadding="0">
		<tr class="thclass" style="height: 40px">
			...
			<td><input type="text" id="ispcode" name="ispcode" class="easyui-validatebox"
					required="true" missingMessage="集团编码不能为空"
					value="" />
			</td>
		</tr>
		<tr class="thclass" style="height: 40px">
			...
			<td><input type="text" id="title" name="title" class="easyui-validatebox"
					required="true" missingMessage="集团名称不能为空"
					value="" />
			</td>
		</tr>
		<tr class="thclass" style="height: 40px">
		...
		<tr class="thclass" style="height: 40px">
			...
			<td><input type="text" id="phone" name="phone" maxlength="200" value="" />
			</td>
		</tr>
		<tr class="thclass" style="height: 40px">
			<th style="width: 130px;">详细地址</th>
			<td><input type="text" id="address" name="address" maxlength="200" value="" />
			</td>
		</tr>
		
		<tr class="thclass" style="height: 40px">
			<th style="width: 130px;">所在地域<font style="color: red">*</font></th>
			<td><input type="text" id="areaid" name="acode" class="easyui-validatebox" value="" />
			</td>
		</tr>
...
function BackIndex(){
	document.location = basepath+'/corp';
}
