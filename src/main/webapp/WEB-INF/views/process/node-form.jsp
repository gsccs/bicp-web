...
<body>
<fieldset>
	<legend style="font-weight: bold; font-size: 16pt; color: #E3393C;">流程节点信息</legend>
	...
	<table cellspacing="0" cellpadding="0">
		<tr class="thclass" style="height: 40px">
				...
				<td>
					<input  type="text" id="tcode" name="tcode"  value="${processNode.tname }" style="width:165px;" required="true" class="easyui-validatebox" missingMessage="不能为空"/>
				</td>
